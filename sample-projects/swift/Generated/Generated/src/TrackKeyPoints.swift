...
extension TrackKeyPoints {

    /**
    Serializes this TrackKeyPoints to a Dictionary.
    ...
    */
    ...
    /**
    Converts the provided array of TrackKeyPoints Objects to an array of dictionaries.
    - Parameter models: An array of TrackKeyPoints Objects to be converted to an array of dictionaries.
    - Returns: An array of Dictionaries
    */
    class func toMapArray(models: [TrackKeyPoints]?) -> [[String: AnyObject]]? {
    ...
    */
	...
	- Parameter array: Array of TrackKeyPoints objects to be serialized.
	- Returns: NSData that contains the serialized objects, or nil if there's a problem serializing them.
	*/
	class func toJsonData(array: [TrackKeyPoints]) -> NSData? {
    ...
    */
    class func toJsonString(array: [TrackKeyPoints]) -> String? {
...
extension TrackKeyPoints {
    ...
    /**
    Gets you a TrackKeyPoints object from the provided map
    - Parameter map: The Map to read the data from.
    - Returns: A TrackKeyPoints object (assuming the map you provided is non-nil)
    */
    class func fromMap(map: [String:AnyObject]?) -> TrackKeyPoints? {
        guard let map = map else {
            return nil
        }

        let model = TrackKeyPoints()
        model.dir = map["dir"] as? Int
    ...
    /**
    Creates an Array of TrackKeyPoints objects for the provided Array of Maps.
    - Parameter mapArray: An array of Maps, assumes that each map is a serialized TrackKeyPoints.
    - Returns: An array of TrackKeyPoints objects (should be 1 to 1).
    */
    class func fromArrayOfMaps(mapArray: [[String:AnyObject]]?) -> [TrackKeyPoints]? {
        guard let mapArray = mapArray else {
            return nil
        }

        var modelArray = [TrackKeyPoints]()
    ...
    /**
    Gives you back a collection of TrackKeyPoints objects for the provided JSON Serialized Data.  This method handles both a single object (map) and an array of objects (array of maps).
    - Parameter data: The NSData (optional) to pull the objects from.
    - Returns: An array of TrackKeyPoints objects that were deserialized from the provided data.
    */
    class func fromData(data: NSData?) -> [TrackKeyPoints]? {
	...
	/**
	 Gives you back a collection of TrackKeyPoints objects after deserializing them from a String to Data, Data to a Dictionary and then finally to a Model Object.
	 - Parameter json: The (UTF-8) JSON String to deserialize into TrackKeyPoints objects.
	 - Returns: An Array of TrackKeyPoints objects.
	*/
	class func fromJson(json: String) -> [TrackKeyPoints]? {
