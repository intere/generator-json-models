/**
 * ContestResultsSponsorTest.swift
 *
...
extension ContestResultsSponsorTest {
    ...
    func testAddress1FromMap() {
        guard let model = ContestResultsSponsor.fromMap(["address1": "I look at God behind his desk, taking notes on a pad, but God’s got this all wrong."]) else {
...
extension ContestResultsSponsorTest {
    ...
    func testCategoryFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["category": "We've all been raised on television to believe that one day we'd all be millionaires, and movie gods, and rock stars. But we won't. And we're slowly learning that fact. And we're very, very pissed off."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }

        XCTAssertEqual("We've all been raised on television to believe that one day we'd all be millionaires, and movie gods, and rock stars. But we won't. And we're slowly learning that fact. And we're very, very pissed off.", model.category, "The category is incorrect")
    }
...
extension ContestResultsSponsorTest {
    ...
    func testContactEmailFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["contactEmail": "I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }
...
extension ContestResultsSponsorTest {
    ...
    func testContactTitleFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["contactTitle": "The things you used to own, now they own you."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }

        XCTAssertEqual("The things you used to own, now they own you.", model.contactTitle, "The contactTitle is incorrect")
    }
...
extension ContestResultsSponsorTest {
    ...
    func testTheIdFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["id": "I look at God behind his desk, taking notes on a pad, but God’s got this all wrong."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }
...
extension ContestResultsSponsorTest {
    ...
    func testLogoFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["logo": "You know how they say you only hurt the ones you love? Well, it works both ways."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }
...
extension ContestResultsSponsorTest {
    ...
    func testNameFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["name": "Yeah. Well. Whatever. You can’t teach God anything."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }
...
extension ContestResultsSponsorTest {
    ...
    func testPhoneNumberFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["phoneNumber": "You know how they say you only hurt the ones you love? Well, it works both ways."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }

        XCTAssertEqual("You know how they say you only hurt the ones you love? Well, it works both ways.", model.phoneNumber, "The phoneNumber is incorrect")
    }
...
extension ContestResultsSponsorTest {
    ...
    func testSiteUrlFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["siteUrl": "I wanted to destroy everything beautiful I'd never have."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }

        XCTAssertEqual("I wanted to destroy everything beautiful I'd never have.", model.siteUrl, "The siteUrl is incorrect")
    }
...
extension ContestResultsSponsorTest {
    ...
    func testZipFromMap() {
        guard let model = ContestResultsSponsor.fromMap(["zip": "It's only after we've lost everything that we're free to do anything."]) else {
            XCTFail("The ContestResultsSponsor was nil")
            return
        }

        XCTAssertEqual("It's only after we've lost everything that we're free to do anything.", model.zip, "The zip is incorrect")
    }
