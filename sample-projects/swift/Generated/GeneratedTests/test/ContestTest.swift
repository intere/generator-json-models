...
extension ContestTest {
    ...
    func testTheIdFromMap() {
        guard let model = Contest.fromMap(["id": "I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom.", model.theId, "The theId is incorrect")
    }
...
extension ContestTest {
    ...
    func testImageUrlFromMap() {
        guard let model = Contest.fromMap(["imageUrl": "You know how they say you only hurt the ones you love? Well, it works both ways."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("You know how they say you only hurt the ones you love? Well, it works both ways.", model.imageUrl, "The imageUrl is incorrect")
    }
...
extension ContestTest {
    ...
    func testLatitudeFromMap() {
        guard let model = Contest.fromMap(["latitude": 1.7556280689386614E308]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(1.7556280689386614E308, model.latitude, "The latitude is incorrect")
    }
...
extension ContestTest {
    ...
    func testLongitudeFromMap() {
        guard let model = Contest.fromMap(["longitude": 6.942936766758967E307]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(6.942936766758967E307, model.longitude, "The longitude is incorrect")
    }
...
extension ContestTest {
    ...
    func testPurseDescriptionFromMap() {
        guard let model = Contest.fromMap(["purseDescription": "I don't want to die without any scars."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I don't want to die without any scars.", model.purseDescription, "The purseDescription is incorrect")
    }
...
extension ContestTest {
    ...
    func testPurseImageUrlFromMap() {
        guard let model = Contest.fromMap(["purseImageUrl": "You know how they say you only hurt the ones you love? Well, it works both ways."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("You know how they say you only hurt the ones you love? Well, it works both ways.", model.purseImageUrl, "The purseImageUrl is incorrect")
    }
...
extension ContestTest {
    ...
    func testPursePrizeValueFromMap() {
        guard let model = Contest.fromMap(["pursePrizeValue": "I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom.", model.pursePrizeValue, "The pursePrizeValue is incorrect")
    }
...
extension ContestTest {
    ...
    func testPurseTypeFromMap() {
        guard let model = Contest.fromMap(["purseType": "We've all been raised on television to believe that one day we'd all be millionaires, and movie gods, and rock stars. But we won't. And we're slowly learning that fact. And we're very, very pissed off."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("We've all been raised on television to believe that one day we'd all be millionaires, and movie gods, and rock stars. But we won't. And we're slowly learning that fact. And we're very, very pissed off.", model.purseType, "The purseType is incorrect")
    }
...
extension ContestTest {
    ...
    func testRunnerUpPrizeValueFromMap() {
        guard let model = Contest.fromMap(["runnerUpPrizeValue": "I wanted to destroy everything beautiful I'd never have."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I wanted to destroy everything beautiful I'd never have.", model.runnerUpPrizeValue, "The runnerUpPrizeValue is incorrect")
    }
...
extension ContestTest {
    ...
    func testRunnerUpPurseImageUrlFromMap() {
        guard let model = Contest.fromMap(["runnerUpPurseImageUrl": "I wanted to destroy everything beautiful I'd never have."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I wanted to destroy everything beautiful I'd never have.", model.runnerUpPurseImageUrl, "The runnerUpPurseImageUrl is incorrect")
    }
...
extension ContestTest {
    ...
    func testScoredFromMap() {
        guard let model = Contest.fromMap(["scored": true]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(true, model.scored, "The scored is incorrect")
    }
...
extension ContestTest {
    ...
    func testSizeFromMap() {
        guard let model = Contest.fromMap(["size": 268110003405793280]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(268110003405793280, model.size, "The size is incorrect")
    }
...
extension ContestTest {
    ...
    func testStateFromMap() {
        guard let model = Contest.fromMap(["state": 5074554820428576768]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(5074554820428576768, model.state, "The state is incorrect")
    }
...
extension ContestTest {
    ...
    func testStateNameFromMap() {
        guard let model = Contest.fromMap(["stateName": "You know how they say you only hurt the ones you love? Well, it works both ways."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("You know how they say you only hurt the ones you love? Well, it works both ways.", model.stateName, "The stateName is incorrect")
    }
...
extension ContestTest {
    ...
    func testTitleFromMap() {
        guard let model = Contest.fromMap(["title": "I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom.", model.title, "The title is incorrect")
    }
...
extension ContestTest {
    ...
    func testTrackIDsFromMap() {
        let arrayData = ["We've all been raised on television to believe that one day we'd all be millionaires, and movie gods, and rock stars. But we won't. And we're slowly learning that fact. And we're very, very pissed off.", "You know how they say you only hurt the ones you love? Well, it works both ways."]  // Array of 2 empty objects
...
extension ContestTest {
    ...
    func testTypeFromMap() {
        guard let model = Contest.fromMap(["type": 3176675290990112768]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual(3176675290990112768, model.type, "The type is incorrect")
    }
...
extension ContestTest {
    ...
    func testTypeNameFromMap() {
        guard let model = Contest.fromMap(["typeName": "It's only after we've lost everything that we're free to do anything."]) else {
            XCTFail("The Contest was nil")
            return
        }

        XCTAssertEqual("It's only after we've lost everything that we're free to do anything.", model.typeName, "The typeName is incorrect")
    }
...
extension ContestTest {
    ...
    func testUserIDsFromMap() {
        let arrayData = ["I let go. Lost in oblivion. Dark and silent and complete. I found freedom. Losing all hope was freedom.", "You know how they say you only hurt the ones you love? Well, it works both ways."]  // Array of 2 empty objects
