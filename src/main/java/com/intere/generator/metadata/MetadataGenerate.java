...
public class MetadataGenerate implements Serializable {
	...
	*/
	...
	/**
	 * Setter for restClients property
	*/
	public void setRestClients(Boolean restClients) {
		this.restClients = restClients;
	}

	/**
	 * Getter for restClients property
	*/
	public Boolean getRestClients() {
	...
	public int hashCode() {
		...
		result = prime * result + ((restClients == null) ? 0 : restClients.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if(restServices == null) {
			...
			return false;
		if(restClients == null) {
			if(other.restClients != null)
				return false;
		} else if(!restClients.equals(other.restClients))
			return false;
		return true;
	}
