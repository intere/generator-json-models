...
public class ModelClassProperty implements Serializable {
	...
	@JsonIgnore
	private ModelClass arraySubTypeClass;		// Transient Property
	@JsonIgnore
	private ModelClass propertyClassType;		// Transient Property
	@JsonIgnore
	...
	*/
	...
	/**
	 * Setter for arraySubTypeClass property
	*/
	public void setArraySubTypeClass(ModelClass arraySubTypeClass) {
		this.arraySubTypeClass = arraySubTypeClass;
	}

	/**
	 * Getter for arraySubTypeClass property
	*/
	public ModelClass getArraySubTypeClass() {
		return this.arraySubTypeClass;
	}

	/**
	 * Setter for propertyClassType property
	*/
	public void setPropertyClassType(ModelClass propertyClassType) {
		this.propertyClassType = propertyClassType;
	}

	/**
	 * Getter for propertyClassType property
	*/
	public ModelClass getPropertyClassType() {
	...
	*/
	...
	public int hashCode() {
		...
		result = prime * result + ((arraySubTypeClass == null) ? 0 : arraySubTypeClass.hashCode());
		result = prime * result + ((propertyClassType == null) ? 0 : propertyClassType.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if(arraySubTypeProperty == null) {
			...
			return false;
		if(arraySubTypeClass == null) {
			if(other.arraySubTypeClass != null)
				return false;
		} else if(!arraySubTypeClass.equals(other.arraySubTypeClass))
			return false;
		if(propertyClassType == null) {
			if(other.propertyClassType != null)
				return false;
		} else if(!propertyClassType.equals(other.propertyClassType))
			return false;
		if(parentModel == null) {
