...
public class JsonDeserializerTest {
	...
	private static final String JSON_ARRAY_OF_STRING = "{\"id\":\"abcd\", \"collection\": [\"string1\", \"string2\", \"string 3\"]}";
	
	@Test
	public void testArrayOfString() throws Exception {
		JsonDeserializer des = new JsonDeserializer("ArrayTest", JSON_ARRAY_OF_STRING);
	...
	public void testBuildName() throws Exception {
		...
		assertEquals("Build Name didn't live up to its name", "TackyToo", JsonNodeUtils.buildSubClassName(des.getName(), "too"));
	}
