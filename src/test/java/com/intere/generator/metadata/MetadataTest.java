...
public class MetadataTest {
	...
	public void testLanguage() {
		assertEquals("The language property didn't deserialize properly", "Java", metadata.getLanguage());
	}

	@Test
	public void testNamespace() {
		assertEquals("The namespace property didn't deserialize properly", "com.intere.test", metadata.getNamespace());
	}
